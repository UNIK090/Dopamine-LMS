...
const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className={`${darkMode ? "bg-gray-800" : "bg-indigo-600"} text-white shadow-md`}
    >
            ...
            <div className="ml-10 flex items-center space-x-4">
              ...
              <div className="relative" ref={userMenuRef}>
                <button
                  ...
                  className="flex items-center space-x-2 p-2 rounded-full hover:bg-indigo-500 hover:bg-opacity-75 transition-colors"
      ...
      <div className={`md:hidden ${isMobileMenuOpen ? "block" : "hidden"}`}>
        <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          {/* Mobile User Info */}
          <div className="px-3 py-2 border-t border-indigo-500 border-opacity-25 mt-2 pt-4">
            ...
            <button
              ...
              className="flex items-center w-full px-3 py-2 rounded-md text-base font-medium hover:bg-indigo-500 hover:bg-opacity-75 transition-colors mb-2"
            >
              {darkMode ? (
                <>
            ...
            <button
              ...
              className="flex items-center w-full px-3 py-2 rounded-md text-base font-medium text-red-200 hover:bg-red-500 hover:bg-opacity-25 transition-colors"
            >
